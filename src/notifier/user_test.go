...
func TestUserWelcomeEmail(t *testing.T) {
	...
	content, err := GetContent(localTemplate, "user_welcome", arg)
	assert.Equal(t, err, nil)
...
func TestUserConfirmEmail(t *testing.T) {
	...
	err := arg.Parse(&config)
	assert.Equal(t, err, nil)
	content, err := GetContent(localTemplate, "user_confirm", arg)
	assert.Equal(t, err, nil)
	t.Logf("content:---------start---------\n%s\n---------end----------", content)
...
func TestUserResetEmail(t *testing.T) {
	...
	err := arg.Parse(&config)
	assert.Equal(t, err, nil)
	content, err := GetContent(localTemplate, "user_resetpass", arg)
	assert.Equal(t, err, nil)
	t.Logf("content:---------start---------\n%s\n---------end----------", content)
