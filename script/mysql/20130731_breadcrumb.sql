...
CREATE INDEX `breadcrumbs_user_id_timestamp` on `breadcrumbs`(`user_id`,`timestamp`);
...
CREATE INDEX `breadcrumbs_windows_user_id_cross_id_start_at_end_at` on `breadcrumbs_windows`(`user_id`,`cross_id`,`start_at`,`end_at`);
CREATE INDEX `breadcrumbs_windows_user_id_cross_id_end_at` on `breadcrumbs_windows`(`user_id`,`cross_id`,`end_at`);